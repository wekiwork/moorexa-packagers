...
use Lightroom\Packager\Moorexa\{
    ...
    MoorexaWebRouterController, ApiStarterPack
};
...
/**
 * @package Moorexa Framework Api Packager
 ...
 */
class MoorexaApiPackager implements PackageManagerInterface, LogbookLoggerInterface, ExceptionHandlerInterface
{
    use ProgramFaults, Configuration\DefaultPackagerConfiguration;

    /**
     * @method MoorexaApiPackager registerPayload for package manager
    ...
    public function registerPayload(Payload &$payload, BootCoreEngine $engine)
    {
         ...
         */ 
        $payload->register('load-router', $payload->handler(RouterHandler::class)->arguments(MoorexaApiRouterController::class, function()
        {
            // configure starter pack
            $this->configureStarterPack('@starter', [
                'main'                =>  [ApiStarterPack::class, 'starterPage'],
                'coming-soon'         =>  [ApiStarterPack::class, 'comingSoon'],
                'maintenance'         =>  [ApiStarterPack::class, 'maintenance'],
                'page-not-found'      =>  [ApiStarterPack::class, 'pageNotFound'],
                'framework-namespace' =>  Framework::class,
                'invalid-controller'  =>  [ApiStarterPack::class, 'invalidController']
            ]);
        }));
    }

    /**
     * @method MoorexaApiPackager registerAliases
