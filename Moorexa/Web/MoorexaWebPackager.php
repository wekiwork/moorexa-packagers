...
use Lightroom\Packager\Moorexa\{
    ...
    MoorexaWebRouterController, StarterPack
};
...
/**
 * @package Moorexa Framework Web Packager
 ...
 */
class MoorexaWebPackager implements PackageManagerInterface, LogbookLoggerInterface, ExceptionHandlerInterface
{
    ...
    public function registerPayload(Payload &$payload, BootCoreEngine $engine)
    {
        ...
        $payload->register('load-router', $payload->handler(RouterHandler::class)->arguments(MoorexaWebRouterController::class, function()
        {
            ...
            $this->configureStarterPack('@starter', [
                'main'                =>  [StarterPack::class, 'starterPage'],
                'coming-soon'         =>  [StarterPack::class, 'comingSoon'],
                'maintenance'         =>  [StarterPack::class, 'maintenance'],
                'page-not-found'      =>  [StarterPack::class, 'pageNotFound'],
                'framework-namespace' =>  Framework::class,
                'invalid-controller'  =>  [StarterPack::class, 'invalidController']
            ]);
        }));
    }
